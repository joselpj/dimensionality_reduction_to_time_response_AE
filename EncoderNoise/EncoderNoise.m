...
xn=XNoise;
NSamples=size(xn,2); %columns of x
Ndata=size(xn,1); % rows of x
Xtrain=zeros(8000,NSamples);
epochs=5000;
for i=1:NSamples
  
   Xtrain(1:8000,i)=xn(1:8000,i);% solo se toman 8000 muestras para acelerar el train 
end
x=Xtrain;
%Create Net
